  ...
  if($cfg['edit'] == 'user') {
   ...
   <form method='post' action='/'>
    ...
    <table class="table">
     ...
     <tr><td>Password</td><td><input name="edit_user_password" type="password" class="form-control" placeholder="Set password" /></td><td></td></tr>
   ...
   <h3>Edit Alias</h3>
   <form method='post' action='/'>
    <input name="edit_alias" type="hidden" value="<?php echo $user['id']; ?>"/>
    <table class="table">
     ...
     <tr><td>Enabled</td><td><input name="edit_user_enabled" type="checkbox" class="form-check-input" id="new_mail_sendonly"value="1" <?php if($user['enabled']) echo "checked"; ?>/></td><td></td></tr>
    </table>
   </form>
   <?php
  }
